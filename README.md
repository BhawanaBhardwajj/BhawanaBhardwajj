...
### Product Manager | MBA (STEM) Candidate @ USC Marshall ’26 | AI & Tech Strategy | 11+ Years in Software & Product

Welcome to my GitHub!  
I build products at the intersection of **technology, user needs, and strategy** — with a growing focus on **AI-driven solutions**.
...
- AI/ML concepts for PMs (LLMs, RAG, embeddings, search, classification)

---

## 🎓 Leadership
**VP of Recruiting – High Tech Association (HTA)**  
- Designed and launched HTA’s first One-on-One Mentorship Program  
- Supported **48+ students** across FTMBA, IBEAR, and MSBA programs  
- Conducted resume reviews, behavioral prep, and mock interviews  
- Focused on giving back to the tech community at Marshall

---

## 🌱 Currently Learning
- Generative AI foundations  
- AI product design frameworks  
- Metrics for AI-based products  
